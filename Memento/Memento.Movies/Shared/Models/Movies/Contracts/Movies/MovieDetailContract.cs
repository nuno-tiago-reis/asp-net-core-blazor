...
{
	/// <summary>
	/// Implements the 'MovieDetail' contract.
	/// </summary>
	[SuppressMessage("ReSharper", "UnusedMember.Global")]
	public sealed class MovieDetailContract
	{
		#region [Properties]
		/// <summary>
		...
		public List<MovieGenreDetailContract> Genres { get; set; }
		...
		public List<MoviePersonDetailContract> Persons { get; set; }
